...
@WebServlet("/api/switchpic")
public class picSwitchContorller extends HttpServlet {
    
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        JSONObject json = JsonUtil.getRequestJsonObject(req);
        Integer id = json.getInteger("switchid");
        String uname = json.getString("uname");
        String upass = json.getString("upass");
        String action = "switch mainpic "+id;
        ...
        if (mianpicDao.switchMainpic(id)){
